...
The [retained discovery trial](.scratch/project-discovery/evidence/06-reassessment-trial.json) and [trial driver](.scratch/project-discovery/trial.py) record the end-to-end checks.
