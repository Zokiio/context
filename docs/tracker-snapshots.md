...
- Supply a ctx binary and choose a local records directory. Ignore disposable snapshots, evidence, binary files, recovery cache, and configuration locks. Preserve durable project guidance.
